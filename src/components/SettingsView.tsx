...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  return (
    <div className="w-full space-y-5">
      {/* Settings Header */}
      <div className="p-5 sm:p-6 rounded-xl glass-card-sharp border border-neutral-300 shadow-2xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-neutral-400 font-mono">Organization Root</span>
            </div>
            <h2 className="text-xl font-bold text-neutral-900 mt-1">Platform Settings</h2>
            <p className="text-xs text-neutral-500">
              Customize your personal leader profile, devotion habits, and workspace configuration.
            </p>
          </div>
      ...
      {activeTab === 'profile' && (
        <form onSubmit={handleSaveProfile} className="space-y-4">
          <div className="p-5 sm:p-6 rounded-xl glass-card-sharp border border-neutral-300 shadow-2xs space-y-5">
            <div className="border-b border-neutral-200 pb-3">
              <h3 className="text-sm font-bold text-neutral-900">Personal Leader Profile</h3>
              <p className="text-xs text-neutral-500">
            ...
            <div className="p-3.5 rounded-lg bg-orange-50/80 border border-orange-300 flex items-center justify-between gap-3 shadow-2xs">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-orange-100 text-orange-800 border border-orange-200 flex items-center justify-center shrink-0">
                  <Crown className="w-5 h-5 text-orange-600" />
                </div>
                <div>
                  <div className="flex items-center gap-2">
                    <h4 className="text-xs font-bold text-orange-950">Workspace Owner</h4>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <div className="relative">
                  <img
                    src={avatar}
                    alt={name}
                    className="w-16 h-16 rounded-full object-cover border-2 border-neutral-300 ring-2 ring-neutral-200 shadow-xs"
                  />
      ...
      {activeTab === 'workspace' && (
        <form onSubmit={handleSaveWorkspace} className="space-y-4">
          <div className="p-5 sm:p-6 rounded-xl glass-card-sharp border border-neutral-300 shadow-2xs space-y-5">
            <div className="border-b border-neutral-200 pb-3">
              <h3 className="text-sm font-bold text-neutral-900">Workspace & Community Settings</h3>
              <p className="text-xs text-neutral-500">
            ...
            <div className="p-4 rounded-lg bg-orange-50/80 border border-orange-300 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-2xs">
              <div className="flex items-center gap-3 min-w-0">
                <div className="relative shrink-0">
                  <img
                    src={avatar}
                    alt={name}
                    className="w-10 h-10 rounded-full object-cover border-2 border-orange-300 ring-2 ring-orange-200 shadow-xs"
                  />
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <h4 className="text-xs font-bold text-orange-950 truncate">{name}</h4>
                    <span className="px-1.5 py-0.2 rounded text-[9px] font-bold uppercase tracking-wider bg-orange-200 text-orange-900 border border-orange-300">
                      Workspace Owner (Admin)
                    </span>
                  </div>
                  <p className="text-[11px] text-orange-800/80 truncate mt-0.5">
            ...
            {!isAdminMode && (
              <div className="p-3 rounded-lg bg-amber-50/90 border border-amber-300 flex items-center gap-2.5 text-xs text-amber-900 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center">
                  <span className="px-3 py-2 rounded-l-lg bg-neutral-100 border border-r-0 border-neutral-300 text-xs text-neutral-500 font-mono">
                    nurture.app/
                  </span>
                  <input
                    type="text"
            ...
            <div className="space-y-3 pt-2">
              <h4 className="text-xs font-bold text-neutral-900">Sprint Lifecycle & Automation Rules</h4>

              <div className="space-y-2.5">
                <label className="flex items-start gap-3 p-3 rounded-lg bg-white/70 border border-neutral-300 cursor-pointer shadow-2xs">
                  <input
                    type="checkbox"
      ...
      {/* ── TAB 3: DEVOTION & NOTIFICATIONS ── */}
      {activeTab === 'notifications' && (
        <form onSubmit={handleSaveProfile} className="space-y-4">
          <div className="p-5 sm:p-6 rounded-xl glass-card-sharp border border-neutral-300 shadow-2xs space-y-5">
            <div className="border-b border-neutral-200 pb-3">
              <h3 className="text-sm font-bold text-neutral-900">Devotion Cadence & Notification Habits</h3>
              <p className="text-xs text-neutral-500">
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 rounded-lg bg-white/70 border border-neutral-300 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-2xs">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-neutral-900">Morning Devotion Check-in Alert</h4>
              ...
              <div className="p-4 rounded-lg bg-white/70 border border-neutral-300 flex items-center justify-between gap-3 shadow-2xs">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-neutral-900">Sunday Sprint Recap Digest</h4>
                    <p className="text-[11px] text-neutral-500">
              ...
              <div className="p-4 rounded-lg bg-white/70 border border-neutral-300 flex items-center justify-between gap-3 shadow-2xs">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-neutral-900">Micro-Interactions & Audio Cues</h4>
                    <p className="text-[11px] text-neutral-500">
